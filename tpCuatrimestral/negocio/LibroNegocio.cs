...
namespace negocio
{
    public class LibroNegocio
    {
        ...
        public List<Libro> BusquedaGeneral(string busqueda)
        {
            List<Libro> lista = new List<Libro>();
            AccesoSQL datos = new AccesoSQL();
            ...
            try
            {
                string criterio = "L.Titulo LIKE '%" + busqueda + "%' OR " +
                   "L.Descripcion LIKE '%" + busqueda + "%' OR " +
                   "A.Nombre LIKE '%" + busqueda + "%' OR " +
                   "A.Apellido LIKE '%" + busqueda + "%' OR " +
                   "G.Nombre LIKE '%" + busqueda + "%' OR " +
                   "G.Descripcion LIKE '%" + busqueda + "%'";
